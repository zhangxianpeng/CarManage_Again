...
public class Location extends Activity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory.fromResource(R.mipmap.fire_blue));
    ...
    private MarkerOptions getMarkerOptions(AMapLocation amapLocation) {
        ...
        //图标
        options.icon(BitmapDescriptorFactory.fromResource(R.mipmap.fire_red));
        //位置
